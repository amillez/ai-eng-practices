...
A repo-shape practice that makes coding agents on `agent-m1` (Claude Code / Codex) land correct changes with less thrash. Inspired by Lauren Tan (poteto)'s GrokBot workshop, as shared on X by Sheema; paraphrased, not quoted.
