...
- **Arena / Swarm / Interrogate** — multi-model design and adversarial review. Map to our chooser (Sol / Opus / Fable / Luna) when needed; do not adopt pstack's panel defaults wholesale. For structured multi-agent fan-out on our stack see [big-work-orchestration.md](big-work-orchestration.md) (**Orca** on `agent-m1`, Opus 5 xhigh coordinator — not deferred).
