...
- **Hard constraints + co-location** — reinforced by poteto's GrokBot workshop: enforce footguns in lint/CI so the proof loop fails closed, and co-locate feature code/tests/docs. See [hard-constraints-and-co-location.md](hard-constraints-and-co-location.md).
